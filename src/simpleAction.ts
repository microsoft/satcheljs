...
export default function simpleAction<T extends SimpleAction>(actionType: string, target: T): T {
    ...
    // Create a mutator
    let simpleMutator = mutator(simpleActionCreator, function simpleActionMutator(actionMessage: any) {
