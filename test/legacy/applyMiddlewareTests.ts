...
import {
    default as legacyApplyMiddleware,
    dispatchWithMiddleware,
} from '../../src/legacy/legacyApplyMiddleware';
...
describe('applyMiddleware', () => {
    ...
    it('Calls middleware during dispatchWithMiddleware', () => {
        ...
        legacyApplyMiddleware((next, action, actionType, actionContext) => {
    ...
    it('Passes action parameters to middleware', () => {
        ...
        legacyApplyMiddleware((next, action, actionType, args, actionContext) => {
            passedAction = action;
